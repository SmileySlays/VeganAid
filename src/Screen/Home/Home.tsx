      ...
      <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 pt-4">
        ...
        <section className="max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-12 leading-relaxed">
            Track nutrition, discover recipes, log meals, and thrive on your plant-based lifestyle.
          </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-24">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white/70 backdrop-blur-sm p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-white/50">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Nutrition Tracking</h3>
              <p className="text-gray-600 leading-relaxed">Monitor calories, macros, and micronutrients with precision.</p>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-sm p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-white/50">
              ...
              <p className="text-gray-600 leading-relaxed">Curated plant-based recipes for every meal and occasion.</p>
            </div>
            ...
            <div className="group bg-white/70 backdrop-blur-sm p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-white/50">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Meal Journal</h3>
              <p className="text-gray-600 leading-relaxed">Log your daily intake and celebrate your progress.</p>
            </div>
          </div>
        </section>
      </main>
